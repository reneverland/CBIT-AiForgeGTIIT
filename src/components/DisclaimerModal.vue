      ...
      <div class="px-6 pb-6 space-y-4">
        ...
        <div class="p-4 rounded-lg"
          ...
          <p class="text-sm leading-relaxed"
            ...
            请将该人工智能的回复作为参考，不代表广东以色列理工学院的官方观点。
          </p>
        </div>
        ...
        <div class="flex items-start gap-3 p-4 rounded-lg border-2"
             :class="isDark ? 'border-gpt-dark-border bg-gpt-dark-bg' : 'border-blue-200 bg-blue-50'">
          <input 
            id="agree-checkbox"
            v-model="agreed"
            type="checkbox"
...
const DISCLAIMER_KEY = 'gtiit_disclaimer_accepted'
...
function handleAccept() {
  ...
  localStorage.setItem('gtiit_disclaimer_accepted_time', new Date().toISOString())
